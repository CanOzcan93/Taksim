...
SWIFT_CLASS("_TtC4Core15CoreApplication")
@interface CoreApplication : UIResponder <UIApplicationDelegate>
...
SWIFT_CLASS("_TtC4Core16CoreCompoundView")
@interface CoreCompoundView : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end


SWIFT_CLASS("_TtC4Core14CoreCoordinate")
@interface CoreCoordinate : CLLocation
...
SWIFT_CLASS("_TtC4Core16CoreListItemView")
@interface CoreListItemView : UITableViewCell
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(CGRect)rect;
...
SWIFT_CLASS("_TtC4Core19CoreLocationManager")
...
SWIFT_CLASS("_TtC4Core13CoreMapMarker")
@interface CoreMapMarker : GMSMarker
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC4Core16CoreMediaManager")
...
@interface CoreMultilineTextInput : UITextView <UITextViewDelegate>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC4Core8CoreView")
...
SWIFT_CLASS("_TtC4Core14CoreSliderItem")
@interface CoreSliderItem : CoreView
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC4Core12CoreTextView")
@interface CoreTextView : UILabel
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)decoder OBJC_DESIGNATED_INITIALIZER;
- (void)drawRect:(CGRect)rect;
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
...
SWIFT_CLASS("_TtC4Core11CoreWebView")
